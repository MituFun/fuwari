...
export const siteConfig: SiteConfig = {
	title: "MituFun\'s Blog",
	subtitle: "MituFun 的博客",
	...
	banner: {
		...
		credit: {
			...
			text: "千早Tihaya", // Credit text to be displayed
			url: "https://www.pixiv.net/artworks/123832598", // (Optional) URL link to the original artwork or artist's page
		},
	},
	toc: {
