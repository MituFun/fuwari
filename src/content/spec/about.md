...
高考结束了，录取结果也出了。高考的结果不如一二模的预期。个别科化学的确是超常发挥了，高于以往最好的成绩。但是物理和生物本以为是最简单的两科，同时也是我高中最擅长的两科却给我背刺了。最后录取结果是要去外地上一个 211 了。

这学校还行，软科排名还挺高的。但是我的专业并不是计算机，因为这个学校在我这里不招计算机的，最后被数据科学与大数据技术录取了。还算是喜欢的，但怎么说还是想延续之前的 OI 节奏。
